#############################################################################
# Makefile for building: build/release/example
# Generated by qmake (3.0) (Qt 5.6.0)
# Project:  example.pro
# Template: app
# Command: /opt/Qt/5.6/gcc_64/bin/qmake -o Makefile example.pro
#############################################################################
...
CXX           = g++
DEFINES       = 
CFLAGS        = -pipe -std=c11 -Wimplicit-function-declaration -O2 -march=native -mtune=native -std=c11 -pthread -Wall -fPIC $(DEFINES)
CXXFLAGS      = -pipe -O2 -std=gnu++0x -pthread -Wall -W -fPIC $(DEFINES)
INCPATH       = -I. -I/usr/include/gtk-3.0 -I/usr/include/at-spi2-atk/2.0 -I/usr/include/at-spi-2.0 -I/usr/include/dbus-1.0 -I/usr/lib/x86_64-linux-gnu/dbus-1.0/include -I/usr/include/gio-unix-2.0 -I/usr/include/cairo -I/usr/include/pango-1.0 -I/usr/include/harfbuzz -I/usr/include/atk-1.0 -I/usr/include/pixman-1 -I/usr/include/freetype2 -I/usr/include/libpng12 -I/usr/include/gdk-pixbuf-2.0 -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/opt/Qt/5.6/gcc_64/mkspecs/linux-g++
...
DISTDIR = /project/gtk/templategtk3/build/release/example1.0.0
LINK          = gcc
LFLAGS        = -Wl,-O1 -s -march=native -mtune=native -O2 -std=c11 -Wl,-z,origin -Wl,-rpath,\$$ORIGIN
LIBS          = $(SUBLIBS) -lgtk-3 -lgdk-3 -lpangocairo-1.0 -lpango-1.0 -latk-1.0 -lcairo-gobject -lcairo -lgdk_pixbuf-2.0 -lgio-2.0 -lgobject-2.0 -lglib-2.0 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = main.c \
		exampleapp.c \
		exampleappwin.c build/release/resources.c
OBJECTS       = build/release/main.o \
		build/release/exampleapp.o \
		build/release/exampleappwin.o \
		build/release/resources.o
DIST          = /opt/Qt/5.6/gcc_64/mkspecs/features/spec_pre.prf \
		...
		/opt/Qt/5.6/gcc_64/mkspecs/features/link_pkgconfig.prf \
		...
		example.pro exampleappwin.h \
		exampleapp.h main.c \
		exampleapp.c \
		exampleappwin.c
QMAKE_TARGET  = example
DESTDIR       = build/release/
TARGET        = build/release/example
...
Makefile: example.pro /opt/Qt/5.6/gcc_64/mkspecs/linux-g++/qmake.conf /opt/Qt/5.6/gcc_64/mkspecs/features/spec_pre.prf \
		/opt/Qt/5.6/gcc_64/mkspecs/common/unix.conf \
		/opt/Qt/5.6/gcc_64/mkspecs/common/linux.conf \
		/opt/Qt/5.6/gcc_64/mkspecs/common/sanitize.conf \
		/opt/Qt/5.6/gcc_64/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents exampleapp.gresource.xml $(DISTDIR)/
...
compiler_gtk_resources_make_all: build/release/resources.c
compiler_gtk_resources_clean:
	-$(DEL_FILE) build/release/resources.c
build/release/resources.c: exampleapp.gresource.xml
	glib-compile-resources exampleapp.gresource.xml --target=build/release/resources.c --sourcedir=/project/gtk/templategtk3 --generate-source
...
compiler_lex_clean:
compiler_clean: compiler_gtk_resources_clean 

####### Compile

build/release/main.o: main.c /usr/include/gtk-3.0/gtk/gtk.h \
		...
		exampleapp.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/release/main.o main.c

build/release/exampleapp.o: exampleapp.c /usr/include/gtk-3.0/gtk/gtk.h \
		/usr/include/gtk-3.0/gdk/gdk.h \
		/usr/include/gtk-3.0/gdk/gdkconfig.h \
		/usr/include/glib-2.0/glib.h \
		/usr/include/glib-2.0/glib/galloca.h \
		...
		exampleapp.h \
		exampleappwin.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/release/exampleapp.o exampleapp.c

build/release/exampleappwin.o: exampleappwin.c /usr/include/gtk-3.0/gtk/gtk.h \
		/usr/include/gtk-3.0/gdk/gdk.h \
		/usr/include/gtk-3.0/gdk/gdkconfig.h \
		/usr/include/glib-2.0/glib.h \
		/usr/include/glib-2.0/glib/galloca.h \
		...
		exampleapp.h \
		exampleappwin.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/release/exampleappwin.o exampleappwin.c

build/release/resources.o: build/release/resources.c 
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/release/resources.o build/release/resources.c
